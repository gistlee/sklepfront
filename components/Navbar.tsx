        ...
        <div className="flex items-center gap-4">
          <div className="hidden md:flex relative w-64">
            <input 
              ...
              className="w-full bg-slate-800/50 border border-slate-700 text-white rounded-full px-4 py-2 pl-10 text-sm focus:outline-none focus:ring-1 focus:ring-primary transition-shadow"
            />
